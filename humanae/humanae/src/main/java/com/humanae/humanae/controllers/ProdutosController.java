...
public class ProdutosController {
	...
	public ResponseEntity<List<Produtos>> findByDescricaoProdutos(@PathVariable String descricao) {
		return ResponseEntity.status(200).body(repository.findByDescricaoContainingIgnoreCase(descricao)); 
	}
