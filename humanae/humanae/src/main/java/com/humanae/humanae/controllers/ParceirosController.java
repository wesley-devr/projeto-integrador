...
public class ParceirosController {
	...
	public ResponseEntity<List<Parceiros>> findByCausa(@PathVariable String causa) {
		return ResponseEntity.status(200).body(repository.findByCausaContainingIgnoreCase(causa)); 
	}
